...
const STR = {
  en: {
    ...
    slow_standfirst: "Who climbed or slipped in the field's pecking order across a decade. Ranks are read within each year, so the indexing wave that lifts every raw count cannot move them: a construct has to out-climb the field just to hold its place.",
  ...
  ar: {
    ...
    slow_standfirst: "مَن صعد ومَن تراجع في ترتيب المجال عبر عقد. تُقرأ المراتب داخل كل عام، فموجة الفهرسة التي ترفع كل عدّ خام لا تحرّكها: على المفهوم أن يسبق المجال لمجرّد أن يحافظ على موقعه.",
